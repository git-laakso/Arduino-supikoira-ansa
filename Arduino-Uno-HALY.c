//************************************************************************************
//**  
//**  Source name:   C:\Users\laaks\Documents\Arduino-Uno-HALY.fcfx
//**  Title:         
//**  Description:   
...
void FCD_05262_switch_base__WaitUntilHigh()
{
	...
	MX_UINT8 FCL_OLD_SWITCHVAL;
		...
		while (1)
		{
			...
			// .switchval = pin
			FCL_SWITCHVAL = GET_PORT_PIN(D, 3);
